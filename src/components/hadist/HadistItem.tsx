...
export default function HadistItem({ hadist, index, onEdit, onDelete, onToggleActive, isDragging }: HadistItemProps) {
  return (
    <div
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button
            ...
            title={hadist.is_active ? 'Nonaktifkan' : 'Aktifkan'}
          >
            <svg
